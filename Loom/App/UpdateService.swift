...
final class UpdateService {
    ...
    private static let expectedBundleID = "com.chasesims.LoomTestingEdition"
    private static let expectedBundleName = "Loom Testing Edition"
    private static let expectedExecutableName = "Loom Testing Edition"
