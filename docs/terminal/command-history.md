...
Loom installs a small zsh shim at `~/Library/Application Support/Loom/shell/.zshrc` in the Loom build. When a Loom terminal pane spawns its login shell, the env it passes through includes:
...
`~/Library/Application Support/Loom/shell/.zshrc` and
