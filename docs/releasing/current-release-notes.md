...
- Mac dictation now keeps the speech recognizer alive after stopping, shows live transcript text on the mic control, and surfaces no-speech failures visibly.
